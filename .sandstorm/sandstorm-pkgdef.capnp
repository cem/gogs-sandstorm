...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "d9ygf47xrtnw12j92cyt6cu8ut75esx01u4q3kcrn8415w9qzzgh",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Gogs"),

    appVersion = 5,  # Increment this for every release.

    appMarketingVersion = (defaultText = "0.11.34-fix1"),
    # Human-readable representation of appVersion. Should match the way you
    # identify versions of your app in documentation and marketing.

    actions = [
      # Define your "new document" handlers here.
      ( title = (defaultText = "New Gogs instance"),
        command = .myCommand
    ...
    metadata = (
      ...
      screenshots = [
        (width = 1150, height = 800, png = embed "screenshot.png")
      ],
